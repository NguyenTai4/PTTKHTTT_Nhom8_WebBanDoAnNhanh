...
<body>
    ...
    <div class="success-wrapper">
        <div class="success-card">
            ...
            <p>Đơn hàng trực tuyến của bạn đã được xác nhận thanh toán thành công và đang được nhà hàng chuẩn bị.</p>
            ...
            <div class="order-info-box">
                ...
                <div class="info-row">
                    ...
                    <span style="color: #2ecc71;">Đã thanh toán (Chờ giao)</span>
                </div>
            </div>

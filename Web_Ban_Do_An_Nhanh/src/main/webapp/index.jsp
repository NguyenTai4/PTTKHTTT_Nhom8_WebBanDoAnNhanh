                ...
                <div class="container nav-container">
                    ...
                    <div class="nav-actions" style="display: flex; align-items: center; gap: 15px;">
                        ...
                        <form action="${pageContext.request.contextPath}/search" method="GET"
                            ...
                            <input type="text" name="keyword" id="searchInput" value="${keyword}"
                                placeholder="Tìm món ăn..." autocomplete="off" onkeyup="fetchSuggestions(this.value)"
                                style="padding: 8px 35px 8px 15px; border-radius: 20px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.2); color: white; width: 220px; outline: none; transition: 0.3s;"
                                onfocus="this.style.width='260px'; this.style.borderColor='var(--color-orange)';"
                                onblur="if(this.value==='') this.style.width='220px'; this.style.borderColor='rgba(255,255,255,0.2)';">
                            <button type="submit"
                                style="position: absolute; right: 10px; background: none; border: none; color: var(--text-muted); cursor: pointer;"><i
                                    class="fa-solid fa-magnifying-glass"></i></button>

                            <!-- 12.6 renderDropdown(suggestions) -->
                            <ul id="suggestionBox"
                                style="display: none; position: absolute; top: 110%; left: 0; right: 0; background: rgba(30, 30, 40, 0.95); backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1); border-radius: 8px; z-index: 1000; list-style: none; padding: 0; margin: 0; box-shadow: 0 4px 15px rgba(0,0,0,0.5); text-align: left; overflow: hidden;">
                            </ul>
                        </form>

                        <button class="btn-icon" style="position: relative;" title="Giỏ hàng"
                            onclick="window.location.href='${pageContext.request.contextPath}/cart'">
                            <i class="fa-solid fa-basket-shopping"></i>
                            <span id="cart-badge-count"
                                style="position: absolute; top: -4px; right: -4px; background: var(--color-orange); color: white; border-radius: 50%; width: 18px; height: 18px; font-size: 0.7rem; display: flex; align-items: center; justify-content: center; font-weight: 700;">
                        ...
                        <c:choose>
                            <c:when test="${not empty sessionScope.loggedUser}">
                                <div class="user-logged-info"
                                    style="display: flex; align-items: center; gap: 12px; background: rgba(255, 94, 54, 0.1); padding: 6px 14px; border-radius: 20px; border: 1px solid rgba(255, 94, 54, 0.2);">
                                    <span
                                        style="color: var(--text-primary); font-weight: 600; font-size: 0.95rem; display: flex; align-items: center; gap: 6px;">
                                        <i class="fa-solid fa-circle-user"
                                            style="color: var(--color-orange); font-size: 1.2rem;"></i>
                                        ${sessionScope.loggedUser.fullname}
                                    </span>
                                    <a href="${pageContext.request.contextPath}/logout" title="Đăng xuất"
                                        style="color: var(--text-muted); transition: var(--transition-fast); display: flex; align-items: center;"
                                        onmouseover="this.style.color='var(--color-orange)'"
                            ...
                            <c:otherwise>
                                <a href="${pageContext.request.contextPath}/pages/login.jsp" class="btn-primary">Đăng
                                    Nhập</a>
                            </c:otherwise>
                        </c:choose>
                    </div>
            ...
            <section id="home" class="hero">
                <div class="container hero-grid">
                    <div class="hero-content">
                        ...
                        <p class="hero-desc">
                            Trải nghiệm hương vị thức ăn nhanh cao cấp được chế biến từ nguyên liệu tươi ngon nhất trong
                            ngày. Giao hàng nóng hổi tận cửa nhà bạn.
                        </p>
            ...
            <section id="menu" class="menu-section">
                <div class="container">
                    <div class="section-header">
                        ...
                        <p class="section-subtitle">Lựa chọn các món ăn ngon nhất được chế biến bởi những đầu bếp chuyên
                            nghiệp của chúng tôi.</p>
                    </div>
                        ...
                        <c:forEach var="food" items="${foodList}">
                            <div class="food-card" data-category="${food.categoryName}">
                                <div class="card-img-wrapper" style="cursor: pointer;"
                                    onclick="window.location.href='${pageContext.request.contextPath}/detail?id=${food.id}'">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <form action="${pageContext.request.contextPath}/cart" method="POST"
                                            style="margin: 0;" onsubmit="ajaxAddToCart(event, this)">
                ...
                <div class="container">
                    <div class="footer-grid">
                        <div class="footer-col footer-about">
                            ...
                            <p class="footer-desc">
                                Hệ thống cung cấp thức ăn nhanh hàng đầu Việt Nam, mang bữa ăn chất lượng nhất, nóng hổi
                                nhất đến cho bạn mọi lúc mọi nơi.
                            </p>
